...
export default function LoginPage() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-slate-50 dark:bg-slate-950">
            <Card className="w-full max-w-md border-0 shadow-xl ring-1 ring-slate-900/5 dark:ring-slate-700/50">
                ...
                <CardContent className="space-y-4">
                    ...
                    {isDev && (
                        <div className="mt-6 space-y-3 pt-4 border-t border-dashed border-slate-200 dark:border-slate-700">
                            <div className="flex items-center gap-2">
                                <span className="h-px flex-1 bg-slate-100 dark:bg-slate-700" />
                                <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">{t.login.modeLabel}</span>
                                <span className="h-px flex-1 bg-slate-100 dark:bg-slate-700" />
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <Button
                                    ...
                                    disabled={isLoading}
                                    className="text-[10px] h-8 border-slate-200 hover:bg-slate-50 dark:border-slate-700 dark:hover:bg-slate-800"
                                >
                ...
                <CardFooter className="justify-center border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 py-4">
