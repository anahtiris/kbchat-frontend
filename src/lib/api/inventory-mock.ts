...
let mockItems: InventoryItem[] = [
    { id: "item-1", name: "Botox Vial 100u", sku: "BTX-100", category: "injectable", unit: "vial", quantity: 12, min_threshold: 5, supplier_name: "Allergan", is_active: true },
    { id: "item-2", name: "Cotton Pads", sku: "CTN-PAD", category: "consumable", unit: "piece", quantity: 200, min_threshold: 50, is_active: true },
    { id: "item-3", name: "Numbing Cream 30g", sku: "NMB-30", category: "topical", unit: "tube", quantity: 1, min_threshold: 3, is_active: true },
    ...
    { id: "item-5", name: "Hyaluronic Filler 1ml", sku: "HYA-1ML", category: "injectable", unit: "syringe", quantity: 4, min_threshold: 4, supplier_name: "Juvederm", is_active: true },
    { id: "item-6", name: "Alcohol Swabs", sku: "ALC-SWB", category: "consumable", unit: "piece", quantity: 0, min_threshold: 100, is_active: true },
...
const mockMovements: StockMovement[] = [
    { id: "mv-1", item_id: "item-1", type: "receive", quantity_delta: 20, performed_by: "Admin User", created_at: "2026-04-01T09:00:00Z" },
    ...
    { id: "mv-3", item_id: "item-3", type: "receive", quantity_delta: 5, performed_by: "Admin User", created_at: "2026-03-20T10:00:00Z" },
...
export const inventoryMockApi = {
    ...
    adjustStock: async (itemId: string, delta: number, notes: string): Promise<InventoryItem> => {
        await delay(300);
        const item = mockItems.find((i) => i.id === itemId);
        if (!item) throw new Error("Item not found");
